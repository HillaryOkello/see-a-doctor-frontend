...
const postAppointment = (userId, doctorId, appointmentDate) => axios.post(`${API_URL}/users/${userId}/appointments`, { doctor_id: doctorId, appointment_date: appointmentDate }, { headers: authHeader() });
